...
namespace TravelReservation.DAL.Migrations
{
    ...
    [Migration("20240610140437_mig_reservation1")]
    partial class mig_reservation1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.Comment", b =>
                {
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.Reservation", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("TravelReservation.EL.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("TravelReservation.EL.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.Comment", b =>
                {
                    b.HasOne("TravelReservation.EL.Concrete.AppUser", "AppUser")
                        .WithMany("Comments")
                        .HasForeignKey("AppUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelReservation.EL.Concrete.Destination", "Destination")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TravelReservation.EL.Concrete.Destination", b =>
                {
                    b.HasOne("TravelReservation.EL.Concrete.Guide", "Guide")
